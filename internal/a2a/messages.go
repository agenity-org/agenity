...
//
// Wire values are ProtoJSON SCREAMING_SNAKE_CASE per A2A v1.0 §5.5,
// matching the canonical enum names in a2a.proto:187 (e.g.
// `TASK_STATE_SUBMITTED`). #573 migrated from the pre-spec lowercase
// + kebab-case forms ("submitted", "input-required") to the
// spec-conformant ProtoJSON form. Refs #561 #573.
