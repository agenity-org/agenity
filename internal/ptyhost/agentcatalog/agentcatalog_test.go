...
// Includes copilot + gemini-cli (#741 free-agent builtins), lean-coder
// (chepherd-native free-tier MCP mesh agent) and tool-coder (lean-coder's
// native-function-calling sibling).
