...
**Authority.** Authored from architect deliberation in [#205](https://github.com/chepherd/chepherd/issues/205) and prior context in [#186](https://github.com/chepherd/chepherd/issues/186). Reflects all decisions from the v0.9.2 architecture review. Living updates land via ADR + semver bump where they change a wire protocol.
